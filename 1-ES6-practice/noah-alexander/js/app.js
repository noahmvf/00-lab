...
function displayPics(){
  ...
  // An error occurred when we declared our variable using 'let' because we console logged it outside the scope of the block in which it was used. The reason we did not see an error with the 'var' declaration is because 'var' defines a variable globally (scoped).
  console.log(viewed)
